...
| --- | --- | --- |
| [`@slipher/cache-integrity`](./packages/cache-integrity) | Hides persistent cache entries until the current process writes them. | [Cache integrity](https://seyfert.dev/docs/plugins/official/cache-integrity) |
