...
import { GatewayDispatchEvents, type GatewayDispatchPayload } from 'seyfert/lib/types/index';
import type { YunaCommandUsable } from '../../things';
import { MessageWatcherManager } from './Manager';
import type { WatcherOptions } from './types';
import type { WatcherContext } from './watcherUtils';
...
export class WatchersController {
	...
	init() {
		...
		client.collectors.create({
			event: 'RAW',
			filter: () => true,
			run({ t: event, d: data }: GatewayDispatchPayload) {
