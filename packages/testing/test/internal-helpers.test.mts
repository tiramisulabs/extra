...
import { InvalidDurationError, parseDuration } from '../src/duration';
import {
	isAmbiguousQueueAddArgs,
	isJobOptionsLike,
	queueAddAmbiguityMessage,
	queueJobOptionKeys,
} from '../src/queue-options';
...
describe('parseDuration', () => {
	...
	test('rejects invalid durations with a directed error', () => {
...
describe('queue.add overload helpers', () => {
	test('recognizes the job option whitelist', () => {
